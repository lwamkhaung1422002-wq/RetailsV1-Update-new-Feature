...
function Metric({ label, value }) { return <Box><Typography color="text.secondary" sx={{ fontSize: 12 }}>{label}</Typography><Typography fontWeight={700} sx={{ mt: 0.25 }}>{value}</Typography></Box>; }
