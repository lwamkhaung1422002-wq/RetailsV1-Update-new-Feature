...
export default function StaffAccessPage() {
  ...
  return <>
    {isMobile ? <Box sx={{ p: 2.25 }}><Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}><Typography variant="h6" fontWeight={800}>Staff & Access</Typography>{isOwner && tab === 0 && <Button variant="contained" onClick={openAdd}>Add Staff</Button>}</Stack>{content}</Box> : <DesktopPage title="Staff & Access" actionLabel={isOwner && tab === 0 ? "Add Staff" : undefined} onAction={openAdd}><DesktopPanel>{content}</DesktopPanel></DesktopPage>}
